// OpenAPI 3.1.2 "source of truth" for Foco Imo Public API (Integrations).
//
// NOTE:
...
export function getPublicApiOpenApiDocument(): OpenApiDocument {
  return {
    openapi: '3.1.2',
    info: {
      title: 'Foco Imo Public API',
      version: 'v1',
      description:
        'API pÃºblica do Foco Imo para integraÃ§Ãµes (n8n/Make). Produto em primeiro lugar: copiar â colar â testar.',
    },
