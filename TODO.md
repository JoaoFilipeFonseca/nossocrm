...
- **NS-2 · CONTACT-360-AI — perfil 360° + IA que relaciona tudo** `[EM CURSO]` `P1`
  ...
  **Falta:** Fase 2 = **auto-enriquecimento** (sugestões DISC/triggers/trimestre/follow-up com Aceitar/Ignorar → grava em `custom_fields`, aprende com o que aceitas). Fase 3 = **memória/aprendizagem** (guardar análises em `contact_ai_analyses`, histórico, ciclo resulta→continua).
  --- visão original ---
