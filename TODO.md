...
- **MA-CREATE · Construtor de anúncios de raiz no CRM ("Novo anúncio", à medida do João)** `[EM CURSO — Fases 1+2 feitas; falta Fase 3 (Anúncio) e Fase 4 (Formulário+CAPI)]` `P?` (CAPTURE 03/06, spec detalhada do João — é o Tier 4 do MA-EDIT-FULL)
