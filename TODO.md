...
- **IMO-6 · CMI (Contrato de Mediação Imobiliária): validade + contagem decrescente + acções** `[EM CURSO]` `P1` (CAPTURE 01/06; corrigido 02/06: é **CMI**, NÃO "mandato" — o João reserva "mandato" para o lado do comprador)
  ...
  **Falta Fase 2 (P1, a seguir):** bloco **Acompanhamento** — KPIs **leads / visitas / propostas** do imóvel + automação periódica (`/automacoes`, [[regra-automacoes-no-crm]]) que, perante **falta de leads / visitas / propostas** e proximidade do fim do CMI, cria **tarefa + alerta Telegram** com acção/estratégia sugerida (liga a **IMO-3** "imóvel parado → alerta IA"). Decidir fontes: visitas/propostas via `imovel_eventos`/`deal_activities`; leads via atribuição.
