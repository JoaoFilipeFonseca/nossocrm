...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    await recordAutomationRun(supabase, 'cmi-watch', false, (e as Error).message);
  ...
  await recordAutomationRun(supabase, 'cmi-watch', runOk, results.find((r) => !r.ok)?.error ?? null);
