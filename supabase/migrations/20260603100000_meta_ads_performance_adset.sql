-- MA-DRILLDOWN Fase 2: RPC meta_ads_performance passa a devolver adset_id/adset_name
-- (para a vista em árvore Campanha→Conjunto→Anúncio em /anuncios). Drop necessário
-- por mudar o tipo de retorno. Grants limpos (authenticated + service_role, sem PUBLIC).
...
returns table(
  ...
  thumbnail_url text, creative_type text
)
