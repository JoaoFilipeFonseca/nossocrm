-- Sprint 13 c2: actualizar compute_honest_metrics para contar activities
-- associadas apenas a contactos (sem deal). Owner = activity.owner_id directo
-- com fallback para deal.owner_id quando há deal. Permite filtrar consultor
-- mesmo em CHQ sem deal associado.
