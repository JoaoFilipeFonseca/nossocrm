...
export const DeleteBoardModal: React.FC<DeleteBoardModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-white dark:bg-dark-card rounded-2xl max-w-md w-full shadow-2xl max-h-[calc(100dvh-2rem)] flex flex-col overflow-hidden"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="flex items-center justify-between p-4 md:p-6 border-b border-slate-200 dark:border-dark-border shrink-0">
        ...
        {/* Footer */}
        <div className="flex flex-col-reverse sm:flex-row gap-2 sm:gap-3 p-4 md:p-6 border-t border-slate-200 dark:border-dark-border shrink-0">
          <button
            onClick={onClose}
