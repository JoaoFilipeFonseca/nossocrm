...
// (negócios + tarefas). Única vista — o painel detalhado legado foi retirado
// (2 Set: só havia uma opção real, o botão de alternar deixou de fazer sentido).
...
const PainelPage: React.FC = () => {
  ...
  useRealtimeSync(['deals', 'activities'], { enabled: true, onchange: onRealtime });
