...
/**
 * @fileoverview AI Modes Test Page (client)
 *
 * Página de teste para validar todos os modos de AI. Renderizada pela
 * page.tsx do lado do servidor, que guarda o acesso (NODE_ENV+flag) antes
 * de sequer montar este componente.
 *
 * @module app/(app)/test/ai-modes/AIModesTestClient
 */
...
export default function AIModesTestClient() {
